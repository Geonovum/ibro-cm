...
Deze bijlage beschrijft hoe de elementen uit BGT en BAG corresponderen met elementen uit de basisregistraties BAG en BGT. Het is geen volledige lijst, maar biedt een eerste opsomming van (mogelijke) knelpunten in de transponering. Naar de WOZ is nog niet gekeken.
